 ...
 */
function createSingleLineHighlighting(
  line: string,
 ...
 */
export function createLineDiffWithWords(
  oldText: string,
  newText: string
): LineDiff[] {
